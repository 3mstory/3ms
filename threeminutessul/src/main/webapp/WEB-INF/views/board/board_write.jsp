...
<body>
  ...
  <nav class="navbar navbar-expand-sm navbar-light bg-white fixed-top">
    <div class="container justify-content-between align-items-center text-secondary">
      <a type="button" href="index.html"><span class="octicon octicon-home text-secondary"></span></a>
      <h3 class="navbar-brand mx-auto p-0 font-header">
        <span class="font-color-main">썰&nbsp;</span>풀기
      </h3>
      <a type="button" href="#" onclick="window.history.back();"><i class=" fas fa-times fa-2x text-secondary"></i></a>
    </div>
  </nav>
      ...
      <nav class="btm-navbar container p-0">
        <ul class="row justify-content-center">
          <li class="px-3 align-items-center">
            <a href="#" class="btn btn-outline-none text-secondary" type="button" data-target="#write_submit_chk"
              data-toggle="modal">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <p>글이 간결하고 가독성이 좋을 수록 상단에 노출될 확률이 높아집니다.</p>
            </div>
